...
chat_live = "services/control-api/app/routers/chat_live.py"
...
cognition = "services/control-api/app/services/cognition_client.py"
replace_once(
    cognition,
